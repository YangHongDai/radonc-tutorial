...
function ensureTutorialPortal() {
  if (document.querySelector(".tutorial-portal")) return;

  const portal = document.createElement("div");
  portal.className = "tutorial-portal";
  portal.innerHTML = '<a href="../index.html">← 放射腫瘤學教學首頁</a><span>Literature Intelligence</span>';
